...
export const MEDIA_STORAGE_ACCOUNT_NAME = process.env.JM1_MEDIA_STORAGE_ACCOUNT_NAME || 'jm1media';
export const MEDIA_STORAGE_CONTAINER = process.env.JM1_MEDIA_STORAGE_CONTAINER || '$web';
...
export const LINKEDIN_CLIENT_SECRET_REFERENCE = process.env.JM1_LINKEDIN_CLIENT_SECRET_REFERENCE || 'jm1-core-vault/JM1-LINKEDIN-ORGANIZATION-PUBLISHER-CLIENT-SECRET';
...
export const LINKEDIN_OAUTH_STATE_SECRET_REFERENCE = process.env.JM1_LINKEDIN_OAUTH_STATE_SECRET_REFERENCE || 'jm1-core-vault/JM1-LINKEDIN-ORGANIZATION-PUBLISHER-OAUTH-STATE-SECRET';
...
export const LINKEDIN_ORGANIZATION_ID = process.env.JM1_LINKEDIN_ORGANIZATION_ID || '13048648';
