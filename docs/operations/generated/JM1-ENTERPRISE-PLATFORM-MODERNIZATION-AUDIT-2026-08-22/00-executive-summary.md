# JM1 Enterprise Platform Modernization Audit - Executive Summary

Date: 2026-08-22

Classification: JM1_PLATFORM_MODERNIZATION_AUDIT_COMPLETE for Phase 1 inventory and planning, with bounded evidence gaps for SaaS/admin surfaces that require separate exports or connectors. No production mutation was performed.

## Estate Size

- Azure subscriptions inspected: 1 (JM1 - Nonprofit Core (2025 Grant))
- Azure resource groups: 39
- Azure resources: 147
- Function Apps: 5
- App Services/Web Apps: 7
- Static Web Apps: 3
- Dataverse environments visible through PAC: 6
- App registrations visible through Entra query: 112
- Key Vaults: 2
- Storage accounts: 11
- GitHub repos visible to gh: 19
