  ...
  return (
    <main className="max-w-4xl mx-auto p-6 bg-black text-white min-h-screen">
      ...
      <div className="flex gap-6">
        <Link href="https://www.jmerrill.one/legal/privacy-policy" target="_blank" className="text-blue-400 underline">Privacy Policy</Link>
        <Link href="https://www.jmerrill.one/legal/terms-and-conditions" target="_blank" className="text-blue-400 underline">Terms of Service</Link>
      </div>
