...
export default function HomePage() {
  return (
    <div className="flex flex-col items-center text-center px-6 py-16 bg-white text-[#111]">
      <HeroLogo />

      <h1 className="text-4xl font-bold mt-6 text-[#1E90FF]">J Merrill One</h1>
      <p className="text-lg mt-2 max-w-2xl text-[#6A5ACD]">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12 max-w-6xl w-full">
        <Link
          ...
          className="block p-6 rounded-2xl shadow-md bg-white hover:shadow-lg border border-[#A3C4DC]"
        >
          <h2 className="text-xl font-semibold text-[#1E90FF] mb-2">Publishing</h2>
        ...
        <Link
          ...
          className="block p-6 rounded-2xl shadow-md bg-white hover:shadow-lg border border-[#A3C4DC]"
        >
          <h2 className="text-xl font-semibold text-[#007F5C] mb-2">Financial</h2>
          <p className="text-sm text-[#444]">
        ...
        <Link
          ...
          className="block p-6 rounded-2xl shadow-md bg-white hover:shadow-lg border border-[#A3C4DC]"
        >
          <h2 className="text-xl font-semibold text-[#93329E] mb-2">Foundation</h2>
          <p className="text-sm text-[#444]">
      ...
      <div className="mt-10 text-sm text-[#6A5ACD]">
