...
export const divisions = [
  {
    ...
    entrySub:   "125+ titles distributed. Full-service from manuscript through market — you own your work.",
  ...
  },
  {
    ...
    entrySub:   "Wills, trusts, and estate structures — clarity and protection for the people who depend on you.",
  ...
  },
  {
    ...
    entrySub:   "From community meal programs to generational impact — giving that reaches further than a single act.",
  ...
  },
  {
    ...
    entrySub:   "Video, audio, and content that carries your story to people who need to hear it.",
