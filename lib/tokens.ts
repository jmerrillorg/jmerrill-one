...
export const divisions = [
  ...
  },
  {
    ...
    humanBody:  "Most families never build the legal and financial foundation to protect what they've worked for. J Merrill Financial does that — before it's too late.",
