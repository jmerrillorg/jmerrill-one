...
export const divisions: Division[] = [
  ...
  },
  {
    ...
    badges: ["Non-attorney planning firm","Rocket Lawyer partnership","Clear family planning support","Headquartered in Columbus, OH"],
    crossDiv: {
      label: "Publishing",
  ...
  },
  {
    ...
    heroBody:  "What you give should not be temporary. J Merrill Foundation is the community impact and nonprofit arm of J Merrill One — creating practical help and lasting change, not just seasonal relief.",
    cta:       "Create Impact",
  ...
  },
  {
    ...
    heroBody:  "What you create should reach further than you can alone. J Merrill Productions is the media and storytelling arm of J Merrill One — producing video, audio, and content that carries mission, message, and movement to the people who need it.",
    cta:       "Amplify Your Message",
    ctaBook:   "Book a Consultation",
    stats:     [["Multi", "Format capability"], ["Wide", "Audience reach"]],
    services: [
    ...
    badges: ["Multi-format production","Wide audience reach","Stories shaped for wider reach","Headquartered in Columbus, OH"],
    crossDiv: {
      label: "Publishing",
      href:  "/divisions/publishing",
